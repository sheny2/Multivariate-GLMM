...
dat <- generate_data_mv(seed = 12345, H, m_hosp, px, p_bin, py, beta, sigma_u, sigma_e, rho)
dat
```


```{r, eval = F}
source("Multi-LMM-Q.R")
...
```{r}
source("Multi-LMM.R") # build likelihood as its original form
